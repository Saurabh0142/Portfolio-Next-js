    ...
    return (
        <li className='relative col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl dark:bg-dark
         dark:border-light'>
            ...
            <Link href={link} target='_blank' >
                <h2 className='capitalize text-2xl font-bold my-2 mt-4 hover:underline xs:text-lg'>{title}</h2></Link>
...
const article = () => {
  return (
    <>
    <Head>
        <title> Saurabh | article Page </title>
    ...
    <main className='w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light'>
        <Layout className='pt-16'>
            ...
            <h2 className='font-bold text-4xl w-full text-center my-16 '>All Article</h2>
