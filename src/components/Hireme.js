...
const Hireme = () => {
  return (
    <div className='fixed left-4  bottom-4 flex items-center justify-between overflow-hidden
    ...
    '>
        <div className='w-48 h-auto flex items-center  justify-center relative md:w-24'>
            ...
            <Link href="saurabh17again@gmail.com" className="flex items-center justify-center 
